...
public class QuartzArmorHandler {
    ...
    public QuartzArmorHandler(JavaPlugin javaPlugin) {
        ...
        for (ArmorType value : ArmorType.values()) {
            ...
            ItemStack itemStack = new ItemBuilder(Material.valueOf("IRON_"+
                    ...
                    .addModifier(Attribute.GENERIC_ARMOR, AttributeModifier.Operation.ADD_SCALAR,
                            switch (value) {
                                case HELMET,BOOTS -> 4;
                                case CHESTPLATE -> 8;
                                case LEGGINGS -> 6;
                            },equipmentSlot)
                            .addModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, AttributeModifier.Operation.ADD_SCALAR,
                                    switch (value) {
                            ...
                            .addModifier(Attribute.GENERIC_ATTACK_DAMAGE, AttributeModifier.Operation.MULTIPLY_SCALAR_1,
                                    0.05,equipmentSlot)
                            .addModifier(Attribute.GENERIC_MAX_HEALTH, AttributeModifier.Operation.ADD_SCALAR,
                                    switch (value) {
                                        case HELMET,BOOTS -> 2;
                                        case CHESTPLATE -> 5;
                                        case LEGGINGS -> 4;
        ...
        javaPlugin.getServer().addRecipe(new ShapedRecipe(NamespacedKey
                .minecraft("quartz_broadsword"),sword = new ItemBuilder(Material.IRON_SWORD).setDisplayName("&b&oQuartz BroadSword"
                        .substring(1)).addModifiers(ItemBuilder.AttributeBuilder.init()
                        .addModifier(Attribute.GENERIC_ATTACK_DAMAGE, AttributeModifier.Operation.ADD_SCALAR,
